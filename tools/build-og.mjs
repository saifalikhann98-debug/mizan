...
body{background:#14534D;color:#F6F4EC;font-family:Outfit,system-ui,sans-serif;-webkit-font-smoothing:antialiased;position:relative}
.wm{position:absolute;left:84px;top:64px;display:flex;align-items:center;gap:14px;font-size:34px;font-weight:500}
.wm svg{width:34px;height:34px}.wm .ar{color:#8FC4B0;font-weight:400;font-size:30px;font-family:'Geeza Pro','IBM Plex Sans Arabic',system-ui}
...
h1 em{font-style:normal;font-weight:500;color:#8FC4B0}
